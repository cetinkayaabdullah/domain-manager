          ...
          <div class="">        
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Domain Lists<small></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                      ...
                      <?php
                       if ( $db->num_rows >= '1'){
                        ...
                        <tr>
                            ...
                            <a href='<?php echo $_link.'view.php?id='.$db_rows->domain_id;?>'>
                                <i class='fa fa-edit'></i>
                            </a>
                            <?php if ($db_rows->domain_ext != 'other') { ?>
                            <a href='<?php echo $_link.'api.php?id='.$db_rows->domain_id;?>'>
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Domains Registered Status<small></small></h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30"></p>
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <?php
                        ...
                        <tr>
                            ...
                            <td><?php $domain_company = $db_rows->reg_id;
